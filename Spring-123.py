                                ...
                                if x4==1:
                                    ...
                                    while  times_of_times1!=Times_compression:
                                                    ...
                                                    while block!=long:
                                                                                ...
                                                                                if Times6>=Deep_long or size_after2!=long_block or  len(data)<=Deep_long_All and Doc==0:
                                                                                    Zeroes4=size_data3[block:block+blocks]
                                                                                    size_after4=len(Zeroes4)
                                                                                    size_data4=Zeroes4

                                                                                    block=block+size_after4
                                                                                                                                                                             elif Zeroes=="0" and size_after2==long_block and Times6<=Deep_long and Doc==1:
